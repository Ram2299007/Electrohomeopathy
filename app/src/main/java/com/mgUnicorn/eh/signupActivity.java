...
import com.mgUnicorn.eh.databinding.ActivitySignupBinding;
   ...
   ProgressDialog progressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >=21) {
            ...
            progressDialog.setTitle("Creataing account");
    ...
    //    mGoogleSignInClient= GoogleSignIn.getClient(this,gso);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //very important intent all time
                Intent intent=new Intent(signupActivity.this,entermobilenoone.class);
                signupActivity.this.overridePendingTransition(0,0);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
