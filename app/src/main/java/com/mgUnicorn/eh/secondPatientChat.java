...
import com.mgUnicorn.eh.databinding.ActivitySecondPatientChatBinding;
...
public class secondPatientChat extends AppCompatActivity implements AdapterView.OnItemSelectedListener {


    ActivitySecondPatientChatBinding binding;
...
//pdf data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySecondPatientChatBinding.inflate(getLayoutInflater());
      ...
      */
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(secondPatientChat.this, MainActivity.class);
        ...
        binding.secondrecyclerview.setAdapter(chatAdapter);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        binding.secondrecyclerview.setLayoutManager(linearLayoutManager);
        ...
        database.getReference().child("PatientChats2new")
                .child(senderRoom)
        ...
        root.child("patientPAYMENT2new").child(FirebaseAuth.getInstance().getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
...
//for send data;
        ...
        binding.paymentSend1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final MediaPlayer mp = MediaPlayer.create(secondPatientChat.this, R.raw.airsound);
                mp.start();
        ...
        binding.imageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(secondPatientChat.this, StorageActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.imgDiagnosis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(secondPatientChat.this, showCasepaper.class);
                startActivity(intent);
        ...
        binding.imgDieaase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(secondPatientChat.this, A.class);
                startActivity(intent);
