...
import com.mgUnicorn.eh.databinding.ActivityGooglePayment2Binding;
...
public class GooglePayment2 extends AppCompatActivity {
    ...
    ActivityGooglePayment2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGooglePayment2Binding.inflate(getLayoutInflater());
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try {
                            ...
                            Toast.makeText(getApplicationContext(), "Please Pay 500 Amount to continue.....", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(name.getText().toString().trim())) {
                    ...
                    Toast.makeText(GooglePayment2.this, "Name is Invalid", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(upivirtualId.getText().toString().trim())) {

                    Toast.makeText(GooglePayment2.this, "Upi Id is Invalid", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(note.getText().toString())) {

                    Toast.makeText(GooglePayment2.this, "Note is Invalid", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(amount.getText().toString().trim())) {

                    Toast.makeText(GooglePayment2.this, "Amount is Invalid", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void payUsingUpi(String name, String upiId, String note, String amount) {
        ...
        if (null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(GooglePayment2.this, "No UPI app found please install one to continue", Toast.LENGTH_SHORT).show();
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(GooglePayment2.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(GooglePayment2.this, "Transaction successfull", Toast.LENGTH_SHORT).show();
                ...
                String msg = "five hundred rupees" +date;
                ...
                startActivity(new Intent(GooglePayment2.this, MainActivity.class));
                ...
                Toast.makeText(GooglePayment2.this, "Transaction failed please try again", Toast.LENGTH_SHORT).show();
                Log.e("UPI", "failed payment: " + approvalRefNo);
            }
        } else {
            Log.e("UPI", "Internet issue: ");
            Toast.makeText(GooglePayment2.this, "Internet connection is not available. Please check and try again.", Toast.LENGTH_SHORT).show();
